class CalculatorView
{
    ...
    displayResult(result) {
        this.domElements.display.textContent === "  " ? this.domElements.display.textContent = "" : this.domElements.display.textContent += " =";
...
class CalculatorModel
{
    ...
    operate() {
        ...
        let res = Math.round((Number(this.left) + Number.EPSILON) * this.ROUNDING_FACTOR) / this.ROUNDING_FACTOR;
        ...
        this.left.includes('.') ? this.onCommaStateChange(false) : this.onCommaStateChange(true);
        return res;
    }
...
const domElements = {digits, operators, comma, equals, clear, del, display, result}
